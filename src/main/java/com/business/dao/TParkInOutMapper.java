...
import com.business.dao.sqlProvider.TParkInOutSqlProvider;
...
public interface TParkInOutMapper {
    ...
    @Insert({
        ...
        "updatedOutCarplate, coupon_type, ",
        "billing_status)",
        ...
        "#{updatedoutcarplate,jdbcType=VARCHAR}, #{couponType,jdbcType=INTEGER}, ",
