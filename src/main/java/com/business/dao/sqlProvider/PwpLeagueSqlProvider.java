...
import com.business.entity.PwpLeagueCriteria.Criteria;
import com.business.entity.PwpLeagueCriteria.Criterion;
import com.business.entity.PwpLeagueCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class PwpLeagueSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(PwpLeagueCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("pwp_league");
     ...
     * @mbg.generated
     */
    public String deleteByExample(PwpLeagueCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("pwp_league");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(PwpLeague record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("pwp_league");
        ...
        if (record.getLeagueStatus() != null) {
            sql.VALUES("league_status", "#{leagueStatus,jdbcType=INTEGER}");
        }
        
        if (record.getLeagueType() != null) {
            sql.VALUES("league_type", "#{leagueType,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(PwpLeagueCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PwpLeague record = (PwpLeague) parameter.get("record");
        PwpLeagueCriteria example = (PwpLeagueCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("pwp_league");
        ...
        if (record.getLeagueStatus() != null) {
            sql.SET("league_status = #{record.leagueStatus,jdbcType=INTEGER}");
        }
        
        if (record.getLeagueType() != null) {
            sql.SET("league_type = #{record.leagueType,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(PwpLeague record) {
        SQL sql = new SQL();
        sql.UPDATE("pwp_league");
        ...
        if (record.getLeagueStatus() != null) {
            sql.SET("league_status = #{leagueStatus,jdbcType=INTEGER}");
        }
        
        if (record.getLeagueType() != null) {
            sql.SET("league_type = #{leagueType,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, PwpLeagueCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
