...
import com.business.entity.TParkInOutCriteria.Criteria;
import com.business.entity.TParkInOutCriteria.Criterion;
...
public class TParkInOutSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TParkInOutCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_park_in_out"+parkID);
        applyWhere(sql, example, false);
        return sql.toString();
     ...
     * @mbg.generated
     */
    public String deleteByExample(TParkInOutCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_park_in_out"+parkID);
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(TParkInOut record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_park_in_out"+parkID);
     ...
     * @mbg.generated
     */
    public String selectByExample(TParkInOutCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        SQL sql = new SQL();
        sql.UPDATE("t_park_in_out"+parkID);
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(TParkInOut record) {
        SQL sql = new SQL();
        sql.UPDATE("t_park_in_out"+parkID);
