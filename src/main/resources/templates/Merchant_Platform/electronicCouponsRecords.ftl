    ...
    <script type="text/javascript">
        ...
        layui.use(['table','form','layer','laydate'], function(){
            ...
            tableIns=table.render({
                ...
                ,height: 400
                ,url: '../ticketCoupon/getticketCoupon' //数据接口  ElectronicCouponRecordsController 查询电子优惠券记录
                ,method:'post'
                // ,toolbar: true
                ...
                ,cols: [[ //表头
                    ...
                    ,{field: 'carplate', title: '车牌', width:170, align:'center'}
                    ,{field: 'inTime', title: '进场时间', width: 190, align:'center', sort: true}
                    ,{field: 'outTime', title: '出场时间', width: 190, align:'center', sort: true}
                    ,{field: 'couponCode', title: '电子券编码', width:140, align:'center'}
                    ,{field: 'couponType', title: '优惠类型', width:170, align:'center',templet:'#couponTypeTemp'}
                    ,{field: 'couponPay', title: '优惠金额', width:170, align:'center'}
                    ,{field: 'busineName', title: '所属商户名称', width:170, align:'center'}
                    ,{field: 'parkName', title: '优惠车场名称', width:170, align:'center'}
                    ,{field: 'ticketName', title: '电子券名称', width:170, align:'center'}
                    ,{field: 'isUse', title: '是否被使用', width:170, align:'center',templet:'#isUseTemp'}
                    ,{field: 'permissionDate', title: '电子券使用时间限制', width:170, align:'center'}
